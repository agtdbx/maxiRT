				...
				t_cube_panel *const	panel)
{
	...
	panel->x_axis_label_button_x.step = 0.001f;
	...
	panel->x_axis_label_button_y.step = 0.001f;
	...
	panel->x_axis_label_button_z.step = 0.001f;
}
				...
				t_cube_panel *const	panel)
{
	...
	panel->y_axis_label_button_x.step = 0.001f;
	...
	panel->y_axis_label_button_y.step = 0.001f;
	...
	panel->y_axis_label_button_z.step = 0.001f;
}
