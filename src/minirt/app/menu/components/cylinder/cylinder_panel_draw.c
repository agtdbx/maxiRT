...
/*   Updated: 2024/04/21 15:47:47 by auguste          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
				...
				t_menu *menu)
{
	...
	should_redraw |= button_draw(mlx, menu,
			&menu->object_panel.cylinder_panel.position_label_button_x);
	should_redraw |= button_draw(mlx, menu,
			&menu->object_panel.cylinder_panel.position_label_button_y);
	should_redraw |= button_draw(mlx, menu,
			&menu->object_panel.cylinder_panel.position_label_button_z);
	vec3_label_draw(mlx, menu,
		&menu->object_panel.cylinder_panel.direction_label);
	should_redraw |= button_draw(mlx, menu,
			&menu->object_panel.cylinder_panel.direction_label_button_x);
	should_redraw |= button_draw(mlx, menu,
			&menu->object_panel.cylinder_panel.direction_label_button_y);
	should_redraw |= button_draw(mlx, menu,
			&menu->object_panel.cylinder_panel.direction_label_button_z);
	return (should_redraw);
}
